...
from backend.db.models import (
    ...
    Partner, PartnerAgreement, PartnerProductRelation,
)
...
def get_customer_orders(session: Session, customer_id: str) -> list[dict]:
...
def get_customer_profile(session: Session, customer_id: str) -> dict | None:
...
def get_supplier_profile(session: Session, supplier_id: str) -> dict | None:
...
def get_supplier_contracts(session: Session, supplier_id: str) -> list[dict]:
...
def get_partner_profile(session: Session, partner_id: str) -> dict | None:
...
def get_partner_agreements(session: Session, partner_id: str) -> list[dict]:
...
def get_partner_products(session: Session, partner_id: str) -> list[dict]:
