...
_MODEL_MAP = {
    ...
    "owner_memory_rules.csv": models.OwnerMemoryRule,
    "memory_entries.csv": models.MemoryEntry,
    "entity_memories.csv": models.EntityMemory,
    "conversation_memories.csv": models.ConversationMemory,
    "conversation_sender_memories.csv": models.ConversationSenderMemory,
    "daily_digest.csv": models.DailyDigest,
